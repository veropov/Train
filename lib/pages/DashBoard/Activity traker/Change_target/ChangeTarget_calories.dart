...
class _ChangeTargetCaloriesState extends State<ChangeTargetCalories> {
  ...
  Widget StepTargetCarousel() => CarouselSlider.builder(
    itemCount: StepsCalories.length, 
    itemBuilder: (context, index, realIndex) => Text('${StepsCalories[index]}', style: TextStyle(fontSize: 65, height: 1.5, fontWeight: FontWeight.w400, color: Color.fromARGB(255, 115, 148, 255), fontFamily: "Poppins"), textAlign: TextAlign.center),
            ...
            children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  onPressed: () {
                    setState(() {
                      textIndexCalories = StepsCalories[indexCalories];
                      //Проверка, добавлен ли виджет подсчета шагов. Если не добавлен - добавляем
                      mapTarget.putIfAbsent('Calories target', () => CaloriesTarget(textIndexCalories));
